...
package com.example.bigdlexamples.utils
 ...
 * 2 epochs training.
 */
class TextClassifierOnHDFS(param: AbstractTextClassificationOnHDFSParams) extends Serializable{
 ...
 */
case class TextClassificationOnHDFSParams(override val baseDir: String = "./",
  ...
  extends AbstractTextClassificationOnHDFSParams
