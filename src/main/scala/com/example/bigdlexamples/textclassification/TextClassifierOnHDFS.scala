...
package com.example.bigdlexamples.textclassification

import com.example.bigdlexamples.utils.TextClassifierOnHDFS
...
object TextClassifierOnHDFS {
  ...
  def main(args: Array[String]): Unit = {
    ...
    localParser.parse(args, TextClassificationParams()).map { param =>
      ...
      val textClassificationOnHDFS = new TextClassifierOnHDFS(param)
      textClassificationOnHDFS.train()
    }
  }
}
